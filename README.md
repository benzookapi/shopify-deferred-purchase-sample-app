...
- [Shopify new login](https://help.shopify.com/en/manual/customers/customer-accounts/new-customer-accounts)'s my page supports deferred purchase option natively, so you don't have to imtegrate any code if the merchant use it instead of the classic login. See the [Wiki](https://github.com/benzookapi/shopify-deferred-purchase-sample-app/wiki) screenshot.
